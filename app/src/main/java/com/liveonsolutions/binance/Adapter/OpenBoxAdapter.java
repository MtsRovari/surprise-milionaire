...
public class OpenBoxAdapter extends RecyclerView.Adapter<OpenBoxAdapter.ItemHolder>{
    ...
    public OpenBoxAdapter(Context context, List<MyBoxResponse> mBoxList) {
    ...
    public ItemHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_open_box, viewGroup, false);
        ...
        try {
            new CountDownTimer(Long.parseLong(box.getDaysToOpen()), 1000) {
                ...
                public void onFinish() {
                    holder.mDays.setText("Caixa Aberta");
                }
